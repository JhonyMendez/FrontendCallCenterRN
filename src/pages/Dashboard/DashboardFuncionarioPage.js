...
export default function DashboardPageFuncionario() {
  ...
  const cargarDatos = async () => {
    try {
      ...
      console.log('📤 [Dashboard Funcionario] Cargando conversaciones de la semana...');
      const hoy = new Date();
      ...
      const conversacionesSemanasDataFuncionario = await conversationMongoService.getStats(
        undefined,
        {
        ...
        console.error('❌ [Dashboard Funcionario] Error al cargar conversaciones:', err);
      ...
      const newStats = {
        ...
        conversacionesHoy: conversacionesSemanasDataFuncionario?.total_conversaciones || 0,
        interaccionesHoy: 0,
        ticketsAbiertos: 0,
        satisfaccion: 0
      };
